...
variante escura suave via `prefers-color-scheme`), layout responsivo mobile-first,
componentes visuais consistentes e requisitos de usabilidade/acessibilidade que todas as
telas seguem. É puramente visual — não altera comportamento, fluxo, endpoints nem a CSP.
